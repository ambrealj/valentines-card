  ...
  return (
    <div className="flex flex-col min-h-screen items-center justify-center">
      ...
      <div className="flex flex-col bg-[#FFF3E6] w-[400px] md:w-[525px] h-[320px] z-0">
        <h1 className="flex items-center justify-center text-center text-4xl w-full h-full">happy valentines <br></br>day!</h1>
        <h1 className="absolute top-[65%] translate-x-[2vh] text-3xl">ambreal</h1>
      </div>
